...
public class Chat extends TableImpl<ChatRecord> {
    ...
    /**
     * The reference instance of <code>SCRAPPER_SCHEMA.CHAT</code>
     */
    ...
    /**
     * The column <code>SCRAPPER_SCHEMA.CHAT.ID</code>.
     */
    public final TableField<ChatRecord, Long> ID = createField(DSL.name("ID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>SCRAPPER_SCHEMA.CHAT.CREATED_AT</code>.
     */
    public final TableField<ChatRecord, OffsetDateTime> CREATED_AT = createField(DSL.name("CREATED_AT"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    /**
     * Create an aliased <code>SCRAPPER_SCHEMA.CHAT</code> table reference
     */
    ...
    /**
     * Create a <code>SCRAPPER_SCHEMA.CHAT</code> table reference
     */
    public Chat() {
