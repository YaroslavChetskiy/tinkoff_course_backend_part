...
public class ChatLink extends TableImpl<ChatLinkRecord> {
    ...
    /**
     * The reference instance of <code>SCRAPPER_SCHEMA.CHAT_LINK</code>
     */
    ...
    /**
     * The column <code>SCRAPPER_SCHEMA.CHAT_LINK.ID</code>.
     */
    ...
    /**
     * The column <code>SCRAPPER_SCHEMA.CHAT_LINK.CHAT_ID</code>.
     */
    public final TableField<ChatLinkRecord, Long> CHAT_ID = createField(DSL.name("CHAT_ID"), SQLDataType.BIGINT, this, "");

    /**
     * The column <code>SCRAPPER_SCHEMA.CHAT_LINK.LINK_ID</code>.
     */
    public final TableField<ChatLinkRecord, Long> LINK_ID = createField(DSL.name("LINK_ID"), SQLDataType.BIGINT, this, "");
    ...
    /**
     * Create an aliased <code>SCRAPPER_SCHEMA.CHAT_LINK</code> table reference
     */
    ...
    /**
     * Create a <code>SCRAPPER_SCHEMA.CHAT_LINK</code> table reference
     */
    public ChatLink() {
    ...
    /**
     * Get the implicit join path to the <code>SCRAPPER_SCHEMA.CHAT</code>
     * table.
     */
    public Chat chat() {
        if (_chat == null)
